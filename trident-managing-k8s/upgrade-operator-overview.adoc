...
TIP: Para obter mais informações sobre a arquitetura do Trident no cluster do Kubernetes, link:trident-concepts/intro.html#trident-architecture["Arquitetura da Trident"]consulte .
