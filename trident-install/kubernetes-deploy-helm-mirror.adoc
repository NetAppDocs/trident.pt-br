...
| `tridentK8sTimeout` | Substitui o tempo limite padrão de 180 segundos para a maioria das operações da API do Kubernetes (se diferente de zero, em segundos). | `180` 
