...
[%collapsible]
====
Para obter informações, consultelink:../trident-reco/force-detach.html["Automatizando o failover de aplicações com estado usando o Trident."] .
...
[%collapsible]
====
Para habilitar operações simultâneas do controlador do Trident e melhorar o desempenho, adicione a opção  `--enable-concurrency` durante a instalação, conforme mostrado neste exemplo. Para obter mais informações sobre os drivers compatíveis, consulte o link: https://docs.netapp.com/us-en/trident/trident-use/controller-scalability.html#controller-scalability[Controller Scalability documentation].
