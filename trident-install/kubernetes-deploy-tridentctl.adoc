...
[%collapsible]
====
Para obter mais informações sobre desprendimento forçado, consultelink:..trident-get-started/kubernetes-customize-deploy.html["Personalizar a instalação do operador Trident"] .
