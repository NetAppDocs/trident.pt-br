...
[%collapsible]
====
Para habilitar operações simultâneas do controlador Trident para melhor rendimento, adicione o `--enable-concurrency` opção durante a instalação, conforme mostrado neste exemplo.
