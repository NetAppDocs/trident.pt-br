...
* Corrigido o problema de aplicativos de máquina virtual KubeVirt recriando incorretamente PersistentVolumeClaims durante operações de reversão, ressincronização reversa e ressincronização de AppMirrorRelationship.
