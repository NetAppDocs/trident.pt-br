...
NOTE: Você também pode usar métodos alternativos para detectar falha de nó, conforme especificado na <<Integrando soluções personalizadas de verificação de integridade de nós>> seção abaixo.
