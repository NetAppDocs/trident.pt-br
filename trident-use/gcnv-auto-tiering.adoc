...
Trident aplica as configurações de armazenamento em camadas automático somente no momento da criação do volume. Alterações posteriores ao provisionamento não são suportadas em Trident 26.06.
...
== Funcionalidade suportada no Trident 26.06

Trident 26.06 oferece suporte aos seguintes recursos de auto-tiering para Google Cloud NetApp Volumes:
...
== Funcionalidade não suportada no Trident 26.06
