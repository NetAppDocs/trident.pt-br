...
| `qosType` | Representa o tipo de QoS: Automático ou Manual. *Prévia técnica do Trident 25.06* | Auto 


| `maxThroughput` | Define a taxa de transferência máxima permitida em MiB/seg. Suportado apenas para pools de capacidade de QoS manual. *Prévia técnica para Trident 25.06* | `4 MiB/sec` 
|===
...
[%collapsible]
====
Esta configuração de backend coloca volumes no Azure  `eastus` localização com pools de capacidade de QoS manuais. *Prévia técnica no NetApp Trident 25.06*.
