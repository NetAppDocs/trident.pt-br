...
| `maxThroughput` | Define a taxa de transferência máxima permitida. Suportado apenas para pools de capacidade de QoS manual. *Prévia técnica para Trident 25.06* | `4 MiB/sec` 
|===
