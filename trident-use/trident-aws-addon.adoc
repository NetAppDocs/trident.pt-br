...
+
image::../media/aws-eks-01.png[Aba de complementos do cluster EKS]

. Vá para *Complementos do AWS Marketplace* e escolha a categoria _storage_.
+
image::../media/aws-eks-02.png[Categoria de armazenamento de complementos do AWS Marketplace]
...
+
image::../media/aws-eks-03.png[Seleção da versão do complemento Trident]

. Configure as configurações necessárias do complemento.
+
image::../media/aws-eks-04.png[Configurações do complemento Trident]
...
+
image::../media/aws-eks-05.png[Status ativo do complemento Trident]
...
----
. Continue a configuração e configure o backend de storage. Para obter informações, consulte link:trident-fsx-storage-backend.html["Configure o back-end de armazenamento"].
