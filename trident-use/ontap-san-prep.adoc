...
NOTE: link:https://docs.netapp.com/us-en/asa-r2/get-started/learn-about.html["Sistemas ASA r2"^] variam de outros sistemas ONTAP (ASA, AFF e FAS) na implementação de sua camada de armazenamento. Em sistemas ASA r2, zonas de disponibilidade de armazenamento são usadas em vez de agregados. Consulte link:https://kb.netapp.com/on-prem/ASAr2/ASAr2_KBs/su_create_by_SVM_admin_using_CLI_fails_with_error_No_candidate_aggregates_are_available_for_storage_services["isto"^] Artigo da Base de conhecimento sobre como atribuir agregados a SVMs em sistemas ASA r2.
...
=== Habilitar autenticação baseada em credenciais
...
=== Atualizar métodos de autenticação ou rotacionar credenciais
...
=== Girar credenciais e atualizar backends
