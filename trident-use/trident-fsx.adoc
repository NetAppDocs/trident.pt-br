...
** Trident suporta volumes SMB montados em pods executados apenas em nós Windows. Consulte link:worker-node-prep.html#prepare-to-provision-smb-volumes["Prepare-se para provisionar volumes SMB"] para obter detalhes.
