...
[role="lead"]
Trident oferece suporte à configuração automática de backend para AWS FSx for NetApp ONTAP (FSxN). Quando você cria um StorageClass que inclui os parâmetros FSxN necessários, Trident cria automaticamente o backend correspondente e um VolumeSnapshotClass.
