...
Para obter uma lista completa dos parâmetros de backend, consulte: xref:trident-fsx-storage-backend.html#backend-advanced-configuration-and-examples[Configuração do backend FSx para NetApp ONTAP].
