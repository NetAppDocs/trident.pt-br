...
. No cluster Kubernetes primário, crie o TridentTridentSnapshotInfoCR para obter detalhes internos.
+
.Exemplo
[source, yaml]
----
...
----
+
.. No cluster Kubernetes secundário, atualize o campo _spec.state_ do CR _TridentMirrorRelationship_ para _promoted_ e _spec.volumeMappings[].promotedSnapshotHandle_ para ser o internalName do snapshot.
