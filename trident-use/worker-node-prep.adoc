...
link:https://docs.netapp.com/us-en/trident/trident-use/worker-node-prep.html#install-the-iscsi-tools["Instale as ferramentas iSCSI"] Se você estiver usando `ontap-san` com sanType ( `fcp`SCSI sobre FC).
