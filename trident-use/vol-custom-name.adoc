...
* No caso do `ontap-nas-economy` No driver, apenas o nome do volume Qtree está em conformidade com o modelo de nome.
* No caso do `ontap-san-economy` No driver, apenas o nome da LUN está em conformidade com o modelo de nome.
...
* Etiquetas personalizadas são suportadas apenas para o `ontap-san`, `ontap-nas`, e `ontap-nas-flexgroup` motoristas.
