...
----
Para ativar a configuração automática de back-end para o Amazon FSX, adicione as seguintes ações ao `policy.json` arquivo ao criar uma política do IAM:
...
* Exemplo de arquivo JSON de política para configuração automática de back-end*:
