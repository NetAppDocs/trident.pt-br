...
NOTE: Os scripts no repositório Verda são fornecidos "como estão" e não são oficialmente suportados pela NetApp. O suporte da NetApp abrange apenas a estrutura de execução de hooks dentro do Trident Protect.
