...
NOTE: Restaurar um backup para um namespace com recursos existentes não alterará nenhum recurso que compartilhe nomes com aqueles no backup. Para restaurar todos os recursos em um backup, exclua e recrie o namespace de destino ou restaure o backup para um novo namespace.
