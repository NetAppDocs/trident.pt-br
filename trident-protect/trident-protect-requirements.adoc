...
* Certifique-se de que exista pelo menos um VolumeSnapshotClass. Para mais informações, consulte link:https://docs.netapp.com/us-en/trident/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"].
...
----
====
Para aprender como definir aplicativos e restaurar VMs com Trident Protect, consulte link:trident-protect-kubevirt-vms.html["Proteja máquinas virtuais KubeVirt com Trident Protect"].
