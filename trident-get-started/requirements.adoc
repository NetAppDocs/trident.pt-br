...
* Versões de cluster FAS, AFF, Select ou ASA r2 (iSCSI e NVMe/TCP) locais com suporte limitado da NetApp. Verlink:https://mysupport.netapp.com/site/info/version-support["Suporte à versão de software"] .
