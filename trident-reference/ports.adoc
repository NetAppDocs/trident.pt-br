...
| TCP/UDP 111 | Saída | RPCBIND/portmapper | ONTAP-NAS (NFSv3/v4), ANF (NFS) | Obrigatório para v3; opcional para v4 (descarregamento do firewall); restringir se estiver usando -only. 
