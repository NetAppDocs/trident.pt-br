...
[role="lead"]
Embora link:../trident-managing-k8s/tridentctl.html["comandos e opções tridentctl"] sejam a maneira mais fácil de interagir com a Trident API REST, você pode usar o endpoint REST diretamente se preferir.
