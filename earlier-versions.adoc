...
[role="lead"]
Se você não estiver executando o Trident 25.10, a documentação para versões anteriores está disponível com base nolink:get-help.html["Ciclo de vida do suporte da Trident"] .
