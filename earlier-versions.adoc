...
[role="lead"]
Se você não estiver executando Trident 26.02, a documentação para versões anteriores está disponível com base no link:get-help.html["Ciclo de vida do suporte da Trident"].
